        ...
        <div class="card-body card-block">
            <form action="{{ route('product-galleries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <label>
                        <input type="radio" name="is_default" id="is_default" value="1" class=" @error('is_default') is-invalid @enderror"/> Ya
                    </label>
                    &nbsp;&nbsp;
                    <label>
                        <input type="radio" name="is_default" id="is_default" value="0" class=" @error('is_default') is-invalid @enderror"/> Tidak
                    </label>
